...
export default function AboutContentForm({ data }: { data: PagesContent["about"] }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="admin-card p-6 space-y-5">
                ...
                <ImageUpload value={bannerImage} onChange={setBannerImage} label="About Page Photo" />
            ...
            <button type="submit" disabled={isPending} className="btn-primary">
                {isPending ? <><Loader2 size={16} className="animate-spin" /> Saving…</> : "Save About Content"}
            </button>
        </form>
    )
}
